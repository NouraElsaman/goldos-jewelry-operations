import { a as cn, n as useI18n } from "./i18n-provider-_D1Twick.js";
import { a as getCurrentRole } from "./router-DG3UxGfP.js";
import { a as formatWeight, i as formatTime, n as formatMoney, o as Skeleton, r as formatNumber } from "./format-fsSknbrn.js";
...
import { n as DonutChartWidget, r as RealtimeIndicator, t as AreaChartWidget } from "./chart-widgets-B_kM9UEX.js";
import { t as SectionCard } from "./section-card-DQskpnzl.js";
import { t as ChartContainer } from "./chart-container-D803bb3t.js";
import { n as TableContainer, t as DataTable } from "./data-table-wQVLPhEH.js";
import { a as fadeUp, i as cardHover, n as StaggerGroup, o as staggerList, r as StaggerItem, t as PageTransition } from "./motion-components-D3lvW4Ya.js";
import { useMemo } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useQuery } from "@tanstack/react-query";
import { motion } from "motion/react";
import { AlertTriangle, ArrowUpRight, Boxes, CheckCircle2, Coins, DollarSign, FileText, Info, Minus, Package, Receipt, RefreshCw, Scale, ShoppingCart, TrendingDown, TrendingUp, Users, XCircle, Zap } from "lucide-react";
//#region src/components/shared/system-health-chip.tsx
var statusStyles = {
...
//#endregion
//#region src/components/shared/kpi-card.tsx
/**
	...
	if (loading) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-24" }), /* @__PURE__ */ jsx(Skeleton, { className: "size-9.5 rounded-xl" })]
			}),
			/* @__PURE__ */ jsx(Skeleton, { className: "h-8 w-32 rounded-xl" }),
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					className: "flex items-center gap-2",
					children: [badge ? badge : null, Icon ? /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [trend ? /* @__PURE__ */ jsxs("span", {
...
//#endregion
//#region src/components/shared/activity-timeline.tsx
/**
...
function ActivityTimeline({ items, isLoading = false, emptyMessage = "No activity yet", onLoadMore, loadMoreLabel = "Load more", className }) {
	if (isLoading) return /* @__PURE__ */ jsx("div", {
		...
		children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx(Skeleton, { className: "mt-0.5 size-8.5 rounded-xl" }),
				/* @__PURE__ */ jsxs("div", {
					className: "flex-1 space-y-2",
					children: [/* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-1/2 rounded-lg" }), /* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-1/3 rounded-lg" })]
				}),
				/* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-12 rounded-lg" })
			]
		}, i))
	});
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(motion.ul, {
			...
			role: "list",
			children: items.map((item) => /* @__PURE__ */ jsx(ActivityItem, {
				icon: item.icon,
				title: item.title,
		...
		}), onLoadMore ? /* @__PURE__ */ jsx(motion.button, {
			...cardHover,
			onClick: onLoadMore,
...
//#endregion
//#region src/components/shared/alert-card.tsx
var severityConfig = {
	info: {
...
//#endregion
//#region src/components/shared/quick-action-card.tsx
/**
...
function QuickActionCard({ icon: Icon, label, description, to, onClick, disabled = false, className }) {
	const inner = /* @__PURE__ */ jsxs("span", {
	...
	if (to) return /* @__PURE__ */ jsxs(motion.div, {
		...cardHover,
		className: baseClass,
...
//#endregion
//#region src/features/dashboard/kpi-section.tsx
/**
...
function KpiSection({ data, isLoading, t, locale }) {
	...
	return /* @__PURE__ */ jsx(StaggerGroup, {
		className: "grid gap-4 sm:grid-cols-2 xl:grid-cols-4",
		children: visibleCards.map((card) => /* @__PURE__ */ jsx(StaggerItem, { children: /* @__PURE__ */ jsx(KpiCard, {
...
//#endregion
//#region src/features/dashboard/gold-price-panel.tsx
...
function GoldPricePanel({ prices, isLoading, isLive = false, lastUpdated, title, description, locale }) {
	...
	return /* @__PURE__ */ jsx(SectionCard, {
		...
		actions: /* @__PURE__ */ jsxs("div", {
			className: "flex items-center gap-3",
			children: [lastUpdateFormatted ? /* @__PURE__ */ jsx("span", {
				className: "text-xs text-muted-foreground",
				children: lastUpdateFormatted
			}) : null, /* @__PURE__ */ jsx(RealtimeIndicator, { active: isLive })]
		}),
		children: isLoading ? /* @__PURE__ */ jsx("div", {
			className: "grid gap-3 sm:grid-cols-2 xl:grid-cols-4",
			children: Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsx("div", { className: "h-16 animate-pulse rounded-xl bg-surface-muted" }, i))
		}) : /* @__PURE__ */ jsx("div", {
			className: "grid gap-3 sm:grid-cols-2 xl:grid-cols-4",
			children: prices.map((price) => /* @__PURE__ */ jsx(PriceRow, {
				price,
				locale
			}, price.karat))
		})
...
//#endregion
//#region src/features/dashboard/chart-section.tsx
/**
...
function ChartSection({ analytics, isLoading, t, locale }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(ChartContainer, {
			...
			children: isLoading ? /* @__PURE__ */ jsx("div", { className: "h-60 w-full animate-pulse rounded-xl bg-surface-muted" }) : /* @__PURE__ */ jsx(AreaChartWidget, {
				data: revenueData,
				height: 240,
			...
			children: isLoading ? /* @__PURE__ */ jsx("div", { className: "h-60 w-full animate-pulse rounded-xl bg-surface-muted" }) : /* @__PURE__ */ jsx(DonutChartWidget, {
				data: karatData,
				height: 240,
...
//#endregion
//#region src/features/dashboard/activity-section.tsx
/** Maps domain event types to Lucide icons. */
var typeIcon = {
	sale: /* @__PURE__ */ jsx(DollarSign, {
		className: "size-4",
		"aria-hidden": true
	}),
	purchase: /* @__PURE__ */ jsx(ShoppingCart, {
		className: "size-4",
		"aria-hidden": true
	}),
	inventory_change: /* @__PURE__ */ jsx(Boxes, {
		className: "size-4",
		"aria-hidden": true
	}),
	price_update: /* @__PURE__ */ jsx(TrendingUp, {
		className: "size-4",
		"aria-hidden": true
	}),
	reconciliation: /* @__PURE__ */ jsx(Scale, {
		className: "size-4",
		"aria-hidden": true
	}),
	user_action: /* @__PURE__ */ jsx(Coins, {
		className: "size-4",
		"aria-hidden": true
	}),
	system: /* @__PURE__ */ jsx(RefreshCw, {
		className: "size-4",
		"aria-hidden": true
	})
};
...
//#endregion
//#region src/features/dashboard/alerts-section.tsx
var severityOrder = {
	critical: 0,
	error: 1,
	warning: 2,
...
function AlertsSection({ alerts, isLoading, t, locale }) {
	...
	return /* @__PURE__ */ jsx(SectionCard, {
		...
		children: isLoading ? /* @__PURE__ */ jsx("div", {
			className: "space-y-3",
			children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsx("div", { className: "h-16 animate-pulse rounded-xl bg-surface-muted" }, i))
		}) : sorted.length === 0 ? /* @__PURE__ */ jsx("p", {
			className: "py-6 text-center text-sm text-muted-foreground",
			children: t("common.empty")
		}) : /* @__PURE__ */ jsx("div", {
			className: "space-y-3",
			children: sorted.map((alert) => /* @__PURE__ */ jsx(AlertCard, {
...
//#endregion
//#region src/features/dashboard/recent-transactions-section.tsx
var cashierNames = {
	usr_1: "فيصل الأصالة",
	usr_2: "نورة حمدان",
	usr_3: "طارق صالح"
...
function RecentTransactionsSection({ invoices, isLoading, t, locale, title }) {
	...
	return /* @__PURE__ */ jsx(SectionCard, {
		title,
		padded: false,
		children: /* @__PURE__ */ jsx(TableContainer, { children: /* @__PURE__ */ jsx(DataTable, {
			columns,
			rows: invoices,
			getRowId: (row) => row.id,
			isLoading,
...
//#endregion
//#region src/features/dashboard/quick-actions-section.tsx
var ACTIONS = [
	{
		id: "sale",
...
function QuickActionsSection({ t, title }) {
	return /* @__PURE__ */ jsx(SectionCard, {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: ACTIONS.map((action) => /* @__PURE__ */ jsx(QuickActionCard, {
				icon: action.icon,
...
//#endregion
//#region src/features/dashboard/system-health-section.tsx
/**
...
function SystemHealthSection({ t, title, services }) {
	return /* @__PURE__ */ jsx(SectionCard, {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			]).map((svc) => /* @__PURE__ */ jsx(SystemHealthChip, {
				label: svc.label,
				status: svc.status,
...
function DashboardPage() {
	...
	return /* @__PURE__ */ jsxs(PageTransition, { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				className: "lg:col-span-2",
				children: /* @__PURE__ */ jsx(ActivitySection, {
					events: activity,
					isLoading: dashLoading,
					t,
					locale
				})
			}), /* @__PURE__ */ jsx(AlertsSection, {
				alerts,
				isLoading: dashLoading,
				t,
				locale
		...
		/* @__PURE__ */ jsx(RecentTransactionsSection, {
			invoices,
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(QuickActionsSection, {
				t,
				title: t("dashboard.quickActions")
			}), /* @__PURE__ */ jsx(SystemHealthSection, {
				t,
